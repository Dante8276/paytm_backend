import { fillField } from "./handleDom";
import { handlePaymentPage } from "./handlePaymentPage";
import { handleSignIn } from "./handleSignIn";
import { readFromStorage, writeToStorage } from "./handleStorage";


export const confirmCartHandler = ` async function(email) {
